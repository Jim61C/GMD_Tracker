...
mkdir -p nets/solverstate/MDNET_ROIPOOL_NOPOOL
cd nets/solverstate/MDNET_ROIPOOL_NOPOOL
wget http://www.jimxingyf.com/static/models/caffenet_train_MDNET_ROIPOOL_NOPOOL_OTB-VOT2014.caffemodel.h5
cd ../../../