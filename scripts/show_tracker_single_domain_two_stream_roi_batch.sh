...
build/show_tracker_vot_gmd_finetune_no_middle_batch_single $DEPLOY $CAFFE_MODEL $SOLVER_FILE $VIDEOS_FOLDER $LAMBDA_SHIFT $LAMBDA_SCALE $MIN_SCALE $MAX_SCALE $GPU_ID $START_VIDEO_NUM $PAUSE_VAL $OUTPUT_FOLDER
